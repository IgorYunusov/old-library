//https://github.com/lindell/Text-to-BMP/blob/master/BMPmaker.cpp
...
int tamain (int nArgs, char* Args[]) {
	
	//Arguments
	int ArgWidth = 100;//atoi(parameterValue(nArgs,Args,"-w").c_str());
  ...
  //  }
	...
	wstring data= Utility::FileIO::ReadFileA(L"D:\\2015-03-01\\Visual Studio 2013\\gamea\\gamea\\q2.txt").Reference();
	count = data.length();
