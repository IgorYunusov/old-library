	...
	public:
		...
		*/
		...
		/*
			...
			@return: 건너뛴 문자의 개수
		*/
		static size_t AdjustPreFindFunction(const char const **ptr, int (func(int)))
		{
		...
		/*
			...
			@return: 건너뛴 문자의 개수
		*/
		static size_t AdjustPreSkipFunction(const char const **ptr, int (func(int)))
		{
			const char *p = *ptr, *o = *ptr;
		...
		/*
			...
			@return: 건너뛴 문자의 개수
		*/
		static size_t AdjustPostFindFunction(const char const **ptr, int (func(int)))
		{
			const char *p = *ptr, *o = *ptr;
		...
		/*
			...
			@return: 건너뛴 문자의 개수
		*/
		static size_t AdjustPostSkipFunction(const char const **ptr, int (func(int)))
		{
			const char *p = *ptr, *o = *ptr;
		...
		*/
		...
		{
			char *o = *ptr;
			AdjustLastPointer((const char **)ptr);
			AdjustPostSkipFunction((const char **)ptr, _isspace);
			*(*ptr + 1) = 0;
			*ptr = o;
		}
