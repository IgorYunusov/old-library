									...
									_u += 2; if (*(++_u) == ']'){
										if (*(++_u) == '>'){
											if (*(++_u) == '['){
												...
												for (int i = sArt_Set; i <= (sArt_Set + 4); i++)
													sArt[i] = falses[i - sArt_Set]; sArt_Set += 5; break;
											}
										}
										else {
											for (int i = sArt_Set; i <= (sArt_Set + 4); i++)
										...
										for (int i = sArt_Set; i <= (sArt_Set + 4); i++)sArt[i]
											= falses[i - sArt_Set]; sArt_Set += 5; break;
									}
								}
								else {
									for
										(int i = sArt_Set; i <= (sArt_Set + 4); i++)sArt[i] = falses[
											i - sArt_Set]; sArt_Set += 5; break;
								}
							}
							else {
								for (int i =
...
int main()
{
	printf("%s", ProcessAll("32sdfgabdsfg", 0, "\\S\\x08:[03]\\x05:[00]>[0F]\\E"));
	return 0;
}