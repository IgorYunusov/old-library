...
struct __Container_base;
struct __Container_proxy
	{
	__Container_proxy() : _Mybase(0) {}

	__Container_base *_Mybase;
	};
...
public:
	...
	__Container_base(const __Container_base&)
		: _Myproxy(0)
		{
		}

	__Container_base& operator=(const __Container_base&)
		{
		return *this;
		}

	~__Container_base() _USE_NOEXCEPT
		{
		}

	__Container_proxy *_Myproxy;
	};
