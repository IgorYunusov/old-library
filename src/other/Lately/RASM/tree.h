...
// VERSION 1.1		$ LASTEST UPDATE 2014/10/10 $
...
public:
	...
	void dswap_left()
		...
		if ((*this->_Mylast).is_left())
			{
			value_type temp = **this->_Mylast;
			**this->_Mylast = **this->_Mylast->_Left;
			**this->_Mylast->_Left = temp;
			}
		}
	...
	void dswap_rl()
		...
		if ((*this->_Mylast).is_left())
			if ((*this->_Mylast).is_right())
				{
				value_type temp = **this->_Mylast->_Right;
				**this->_Mylast->_Right = **this->_Mylast->_Left;
				**this->_Mylast->_Left = temp;
				}
		}
