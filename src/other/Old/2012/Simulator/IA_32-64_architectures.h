...
#ifndef _IA_32_64_DEF
#define _IA_32_64_DEF

// Accumulator for operands and results data
// 피연산자 및 결과 데이터에 대한 누산기
#define EAX		1
...
// DS 레지스터를 가리키는 세그먼트의 데이터의 포인터; 문자열 작업의 소스 포인터
#define ESI		5

// EDI — Pointer to data (or destination) in the segment pointed to by the ES register; destination pointer for string operations
// ES 레지스터를 가리키는 세그먼트의 데이터의 포인터; 문자열 연산에 대한 대상 포인터
#define EDI		6
